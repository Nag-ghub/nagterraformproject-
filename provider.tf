...
terraform {
  required_providers {
   ...
   backend "azurerm" {
    resource_group_name   = "nag-rg" #replace the same with your storage account rg
    storage_account_name  = "tfstoragenag" #replace the same with your own storage account
